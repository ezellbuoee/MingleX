...
import com.ksv.minglex.service.MemoryLeakService;
...
public class StatusController {
	...
	@RequestMapping(value = "/leaking", method = RequestMethod.GET)
	public ModelAndView leaking(Model model, HttpServletRequest request) {
		ModelAndView modelAndView = new ModelAndView();
		...
		List<Status> statuses = statusService.findAllAndLeak();
